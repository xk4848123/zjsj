...
@WebServlet(value = "/isinfocomplete", asyncSupported = true)
public class UserIsAuthServlet extends HttpServlet {
	
	private static Logger log = Logger.getLogger(UserIsAuthServlet.class);
			...
			public void onAllDataRead() {
				ThreadPoolExecutorSingle.executor.execute(() -> {
					...
					try {
						...
						resultMap.put("isAuth", userService.isAuth(userId));
